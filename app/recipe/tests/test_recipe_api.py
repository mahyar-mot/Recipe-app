...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        """TEest returning recipes with specific tags"""
    ...
    def test_filter_recipes_with_ingredients(self):
        """Test for returning recipes with specific ingredient"""
        recipe1 = sample_recipe(user=self.user, title='Posh beans on toast')
        recipe2 = sample_recipe(
            user=self.user,
            title='Posh beans on Chiken cacciatore'
        )
        ingredient1 = sample_ingredient(user=self.user, name='Feta Cheese')
        ingredient2 = sample_ingredient(user=self.user, name='Feta Chicken')
